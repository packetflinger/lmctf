...
#define	CHAN_ITEM               3
#define	CHAN_BODY               4
#define CHAN_CTF				5 // LM_JORM -- CTF code
// modifier flags
...
#define STAT_TEAM_ICON			18		// TEAM_CODE -- LM_JORM
#define STAT_RED_FRAGS			19		// TEAM_CODE -- LM_JORM
#define STAT_BLUE_FRAGS			20		// TEAM_CODE -- LM_JORM
#define STAT_RED_ICON			21		// TEAM_CODE -- LM_JORM
#define STAT_BLUE_ICON			22		// TEAM_CODE -- LM_JORM
#define STAT_RUNE_ICON			23		// TEAM_CODE -- LM_JORM
...
#define CTF_ALLOW_INVULN		2 //SURT to turn off invulnerability
#define CTF_TEAM_RESET			4 
#define CTF_TEAM_NOSWITCH		8 
#define CTF_OFFHAND_HOOK		16 

#ifdef NOVOICE_OK
#define CTF_NOVOICE				32 //surt to turn off speaking outloud
#endif

#define CTF_NO_GRAP_DAMAGE		64 //surt to turn off all damage from grapple
#define CTF_TEAM_NOTEAMS		128 //surt turn off teamplay, for deathmatch
#define CTF_FLAGS_NOFLAGS		256 //surt for team deathmatch
#define CTF_SCORE_BALANCE		512 //surt balances scores for small/large teams
#define CTF_TEAM_ARMOR_PROTECT          1024 //hati prevent own teammates from taking away armor
#define CTF_DM_POWER_ARMOR_STRENGTH     2048 //hati set to allow DM-equivalent power armor

#define CTF_RANDOM_MAPS			4096	// bat
#define CTF_RANDOM_QUAD			8192	// bat
#define CTF_RANDOM_DEATH_MSG	16384	// bat
#define CTF_VOTEMENU_OFF		32768	//Vampire -- voting menu
...
#define RUNE_HASTE				4
#define RUNE_REGEN				8
#define RUNE_VAMP				16	//added by Vampire

// Flags for radio
//#define RADIO_OFF		0
//#define RADIO_ON		1
//#define RADIO_TEXT	2
//#define RADIO_BOTH	4 //surt fixme do we actually maybe want to turn this into flags?

//assorted client flags, in the true meaning
#define CTF_EXTRAFLAGS_CAMERA_LOCKED	1
#define CTF_EXTRAFLAGS_REFEREE			2
#define CTF_EXTRAFLAGS_RCON				4
#define CTF_EXTRAFLAGS_CAMERA_REVERSE	8
#define CTF_EXTRAFLAGS_RADIO_TEXT		16
#define CTF_EXTRAFLAGS_RADIO_SOUND		32
//Vampire: the following flags are declared in g_vote.h
//#define CTF_EXTRAFLAGS_VOTE_YES			64        //Vampire -- voting menu
//#define CTF_EXTRAFLAGS_VOTE_NO			128       //Vampire -- voting menu

//assorted ent flags, in the true meaning
//#define CTF_PROPS_FROZEN					1
