...
extern cvar_t       *coop;
extern cvar_t       *countdown_time;
extern cvar_t       *ctfflags;      // bitmask
extern cvar_t       *deathmatch;
extern cvar_t       *dedicated;
extern cvar_t       *disabled_weps;
extern cvar_t       *dmflags;       // bitmask
...
extern cvar_t       *mod_website;   // URL in team join centerprint
extern cvar_t       *motd_file;
extern cvar_t       *needpass;
extern cvar_t       *password;
extern cvar_t       *railtime;
extern cvar_t       *rconpassword;
extern cvar_t       *refpassword;
extern cvar_t       *refset;
extern cvar_t       *runes;
extern cvar_t       *run_pitch;
extern cvar_t       *run_roll;
extern cvar_t       *server_file;
extern cvar_t       *skill;
extern cvar_t       *skinset;
extern cvar_t       *skin_debug;
extern cvar_t       *skin_file;
...
extern char     motd[1000];
extern MapInfo  maplist[300];
extern int      maplistindex;
extern int      bluescore, redscore;
extern char     helptext[1000][25];
...
struct gclient_s {
    ...
    int             plasma_mode;        // current weapon mode (SKWiD)
    int             hookstate;
    vec3_t          hookend;
    vec3_t          hookangle;
    int             hooklength;
